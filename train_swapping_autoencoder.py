...
from models.ae import AE, VQVAE, DualLatentAE, DualLatentWithSwappingAE
...
def training():
    ...
    comet_logger = set_up_comet_logger(model=model, model_config=model_config, test_sample=next(iter(test_loader)), tags=[model_config.name, 'SWAPPING', 'PATCH DISCRIMINATOR', 'SIZE TEST'])
